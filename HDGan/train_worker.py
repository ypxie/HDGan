...
def train_worker(data_root, model_root, training_dict):
    ...
    parser.add_argument('--reuse_weights',             default= training_dict['reuse_weights'], help='continue from last checkout point')
    parser.add_argument('--load_from_epoch', type=int, default= training_dict['load_from_epoch'],  help='load from epoch')

    parser.add_argument('--batch_size', type=int,      default=training_dict['batch_size'], metavar='N', help='batch size.')
    parser.add_argument('--device_id', type=int,       default=training_dict['device_id'],  help='which device')
    ...
    parser.add_argument('--g_lr', type=float, default = training_dict['g_lr'], metavar='LR',
                        help='learning rate (default: 0.01)')
    parser.add_argument('--d_lr', type=float, default = training_dict['d_lr'], metavar='LR',
                        help='learning rate (default: 0.01)')
