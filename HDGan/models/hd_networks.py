...
class Generator(nn.Module):
    def __init__(self, sent_dim, noise_dim, emb_dim, hid_dim, num_resblock = 2):
        ...
        self.side_output_at = [64, 128, 256] 
...
class Discriminator(torch.nn.Module):
    def __init__(self, num_chan,  hid_dim, sent_dim, emb_dim, r_list=[1,3,5]):
        ...
        emb_dim : int
            the dimension of compressed sentence embedding.
        r_list:  list
            contains local loss size for discriminator at scale [64, 128, 256].
        """
